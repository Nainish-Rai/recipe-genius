...
function page({}: Props) {
  ...
  //   fetch(`/api/images/?q=${query}`)
  //     .then((res) => res.json())
  //     .then((res) => console.log(res));
  // };
  // fetchImage("paalak panner");
  return (
    <div className="w-full max-w-6xl mx-auto">
      <h2>
        {data &&
          data.map((item, index) => {
            return (
              <div className="shadow-md p-4 px-6 rounded-2xl my-2" key={index}>
                ...
                <div className="pl-1">
                  ...
                  <div>
                    <h4 className="font-medium text-xl underline my-2">
                      Instructions
                    </h4>
                    <ul className="ml-4">
